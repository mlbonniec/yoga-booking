...
## Install `git`
To install the utilitary `git` that will permit us to manage our Github content, we'll have to install the Github Desktop application. Simply [download it](https://desktop.github.com/) from the official Github website.  
